...
package com.paraview.gestruresdk.view;
...
import com.paraview.gestruresdk.R;
...
public class PatternView extends View {
    ...
    private void notifyPatternStarted() {
        sendAccessEvent(ResourceUtils.getIdByName(getContext(), "string", "pl_access_pattern_start"));
        if (mOnPatternListener != null) {
    ...
    private void notifyPatternDetected() {
        sendAccessEvent(ResourceUtils.getIdByName(getContext(), "string", "pl_access_pattern_detected"));
        if (mOnPatternListener != null) {
    ...
    private void notifyPatternCleared() {
        sendAccessEvent(ResourceUtils.getIdByName(getContext(), "string", "pl_access_pattern_cleared"));
        if (mOnPatternListener != null) {
    ...
    private final class PatternExploreByTouchHelper extends ExploreByTouchHelper {
        ...
        public void onPopulateAccessibilityEvent(View host, AccessibilityEvent event) {
            ...
            if (!mPatternInProgress) {
                CharSequence contentDescription = getContext().getText(
                        ResourceUtils.getIdByName(getContext(), "string", "pl_access_pattern_area"));
        ...
        private boolean shouldSpeakPassword() {
            ...
            @SuppressLint("InlinedApi") final boolean speakPassword = Settings.Secure.getInt(getContext().getContentResolver(),
                    Settings.Secure.ACCESSIBILITY_SPEAK_PASSWORD, 0) != 0;
            @SuppressWarnings("deprecation") final boolean hasHeadphones = mAudioManager != null
        ...
        private CharSequence getTextForVirtualView(int virtualViewId) {
            ...
            return shouldSpeakPassword() ?
                    res.getString(ResourceUtils.getIdByName(getContext(), "string", "pl_access_pattern_cell_added_verbose"), virtualViewId)
                    : res.getString(ResourceUtils.getIdByName(getContext(), "string", "pl_access_pattern_cell_added"));
        }
