...
public class FingerPrinterView extends View {
    ...
    private void initBitmap() {
        mFingerRed = ((BitmapDrawable) mResources.getDrawable(ResourceUtils.getIdByName(getContext(), "drawable", "finger_red"))).getBitmap();
        mFingerGreen = ((BitmapDrawable) mResources.getDrawable(ResourceUtils.getIdByName(getContext(), "drawable", "finger_green"))).getBitmap();
        mFingerGrey = ((BitmapDrawable) mResources.getDrawable(ResourceUtils.getIdByName(getContext(), "drawable", "finger_grey"))).getBitmap();
